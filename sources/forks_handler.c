...
/*   Updated: 2022/10/21 16:59:22 by dcandeia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	update_fork_status(&phi->left->lock, &phi->left->status, FORK_AVAILABLE);
	update_fork_status(&phi->right.lock, &phi->right.status, FORK_AVAILABLE);
